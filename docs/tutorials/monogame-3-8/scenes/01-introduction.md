...
slug: /tutorials/monogame-3-8/scenes/introduction
---
...
## Code License
All code written in this **Scene** tutorial series, unless otherwise stated, is licensed under The Unlicense.  This license extends to only the code written, not the tutorial documentation.  The license text is as follows:
